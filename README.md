...
The process of gentrification, which involves the revitalization of declining urban areas by more affluent individuals and businesses, has a history dating back to the beginning of the 20th century. One significant catalyst of this trend was the mass migration of wealthy, white households from cities to suburbs following World War II, which was influenced by a combination of personal preferences, government policies, and economic conditions. These factors, along with systemic racism, discriminatory lending practices, and inadequate investment by municipalities, contributed to the growth of suburbanization. Despite being referred to as a localized and insignificant phenomenon in the 1980s, it's now clear that gentrification is neither limited to specific locations nor short-lived. 

While there are multiple classifications of gentrification, the general patterns from a neighborhood demographic point of view does provide a succint definition: A sustained period of disinvestment, followed by an influx of investment and wealthier residents, in some cases correlated with race,  that results in the displacement of existing residents
...
The number of tracts in wards 7 and ward 8 which are predicted to be gentrified is much higher in 2030. Many of the previously identified areas continue to be identified as gentrified, especially east of the Anacostsia.This is expected, since gentrification often happens over a span of 20-30 years. A few new areas have also been identified with lower spatial concentration.Importantly many of the areas currently identified as gentrifying have not been highlighted to be so in 2030, indicating that they will be fully gentrified and become high income areas. It is therefore important to carefully evaluate these changing patterns and undertake interventions such as the Minneapolis 2040 plan, which aim to create "mixed" neighborhoods, to reduce population displacement. These areas provide important insights which require not only government interventions, but provide an important agenda to local neighborhood advocates, as an early warning sign.
